...
from .rh import cout_embauche, cout_licenciement

PRENOMS = ["Alex", "Marie", "Lucas", "Sophie", "Karim", "Claire", "Hugo", "Lea", "Antoine", "Nadia"]
NOMS = ["Durand", "Moreau", "Lefevre", "Garcia", "Bernard", "Petit", "Roux", "Fontaine"]
